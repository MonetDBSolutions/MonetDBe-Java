...
install_name_tool -change $1/lib/libmonetdbe.1.dylib @rpath/libmonetdbe.1.dylib /home/runner/work/.m2/repository/monetdb/monetdbe-java-native/1.0-SNAPSHOT/monetdbe-java-native-1.0-SNAPSHOT.dylib
